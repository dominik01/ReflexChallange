...
jQuery(function($){    
    ...
    var IO = {
         ...
         * @param data
         */
        beginNewGame : function(data,playersData) {
            App[App.myRole].gameCountdown(data,playersData);
        },
    ...
    var App = {
        ...
        Host : {
            ...
            gameInit: function (data) {
                ...
                var hostData = {
                    gameId : data.gameId,
                    playerName : $('#username').html() || 'anon',
                    mySocketId : App.mySocketId
                };
                App.Host.players.push(hostData);
            ...
            updateWaitingScreen: function(data) {
                ...
                if (App.Host.numPlayersInRoom === 2) {
                    ...
                    IO.socket.emit('hostRoomFull',App.gameId,App.Host.players);
                }
            },
        ...
        Player : {
             ...
             * @param hostData
             */
            gameCountdown : function(hostData,playersData) {
                ...
                $('#player1Score')
                    .find('.playerName')
                    .html(playersData[0].playerName);

                $('#player2Score')
                    .find('.playerName')
                    .html(playersData[1].playerName);

                // Set the Score section on screen to 0 for each player.
                $('#player1Score').find('.score').attr('id',playersData[0].mySocketId);
                $('#player2Score').find('.score').attr('id',playersData[1].mySocketId);
            },
